...
import dev.edmt.aplikasipetanifix.admin.lap_admin_investor_singgle;
import dev.edmt.aplikasipetanifix.admin.lap_admin_investor;
import dev.edmt.aplikasipetanifix.admin.model.lap_inv_ku;


public class lap_inv_rv extends RecyclerView.Adapter<lap_inv_rv.ViewHolder> {

    private ArrayList<lap_inv_ku> daftarBsSaldo;
    private Context context;
    FirebaseDataListener listener;

    public lap_inv_rv(ArrayList<lap_inv_ku> hap_kuses, Context ctx){
        /**
         * Inisiasi data dan variabel yang akan digunakan
         */
        daftarBsSaldo = hap_kuses;
        context = ctx;
        listener = (lap_admin_investor)ctx;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cvMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 */
                context.startActivity(lap_admin_investor_singgle.getActIntent((Activity) context).putExtra("data", daftarBsSaldo.get(position)));
            }
        });
    ...
    public interface FirebaseDataListener{
        void onDeleteData(lap_inv_ku lap_inv_ku, int position);
    }
}
