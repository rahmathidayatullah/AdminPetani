...
public class asCreate_saldo_Investor extends AppCompatActivity {
        ...
        if (saldo != null) {
            ...
            btSubmit.setOnClickListener(new View.OnClickListener() { // ketika tombol button diklik
                ...
                public void onClick(View view) {
                    ...
                    saldo.setemail(etSaldo.getText().toString());
    ...
    private void updateBarang(saldo saldo) {
         ...
         */
        database.child("INVESTOR-req") //akses parent index, ibaratnya seperti nama tabel
    ...
    private void submitBarang(saldo saldo) {
         ...
         */
        database.child("INVESTOR-req").push().setValue(saldo).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                etEmail.setText("");
                etSaldo.setText("");
    ...
    public static Intent getActIntent(Activity activity) {
        ...
        return new Intent(activity, asCreate_saldo_Investor.class);
    }
}
