...
public class ha_p_ku implements Serializable {


    private String key,alamat,jenisbang,name,nik,nohp,norek,email,saldo,totaltarik;
    ...
    public ha_p_ku(String a, String b, String c, String f, String g, String h, String i, String j, String k){
            email=a;
            totaltarik = b;
            alamat= c;
            jenisbang= f;
